...
To start, I encoded a mapping from the fiary codes to the location names as key-value pairs. In Lua, the table type is used for arrays and dictionaries. I wrote the mapping in the syntax for a table literal and assigned that to a variable in the module.
